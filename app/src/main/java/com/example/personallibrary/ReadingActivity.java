...
public class ReadingActivity extends AppCompatActivity /*implements TimePickerDialog.OnTimeSetListener*/{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        timell.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TimePickerDialog timePickerDialog=new TimePickerDialog(ReadingActivity.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
        ...
        notification.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(ReadingActivity.this, "REMINDER SET FOR: " + DateFormat.getTimeInstance(DateFormat.SHORT).format(c.getTime()) + " every "+ mRepeatNo + " " + mRepeatType + "(s)", Toast.LENGTH_SHORT).show();
    ...
    private void startAlarm(Calendar c, long repeatTime) {
        ...
        Log.d("ReadingActivity", "startAlarm: "+ids.size());
        for (int i=0; i<ids.size(); i++) {
            Intent intent = new Intent(this, com.example.personallibrary.NotificationReceiver.class);
